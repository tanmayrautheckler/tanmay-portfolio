    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6">
      ...
      <section className="py-4">
        <div className="grid grid-cols-4 md:grid-cols-12 gap-3 auto-rows-[140px]">
          ...
          {/* Section header */}
          <BentoCard className="col-span-4 md:col-span-12 row-span-2 p-8 md:p-12 flex flex-col justify-end grid-bg relative" delay={0}>
            <div className="glow-orb w-[500px] h-[300px] bg-accent/10 -top-20 right-0" />
            <div className="relative z-10">
      ...
      <section className="py-4">
        <div className="grid grid-cols-4 md:grid-cols-12 gap-3 auto-rows-[140px]">
          ...
          {/* Experience card */}
          <BentoCard className="col-span-4 md:col-span-7 row-span-3 p-8 md:p-10 flex flex-col justify-between" delay={0}>
            <div>
              <p className="text-accent text-xs font-mono tracking-[0.25em] uppercase mb-4 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-accent pulse-dot" />
                Career
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <div className={`w-2 h-2 rounded-full mt-2 ${job.active ? "bg-accent pulse-dot" : "bg-border"}`} />
                    <div>
                      <div className="text-sm font-medium">{job.role}</div>
                      <div className="text-xs text-text-secondary">{job.company} &middot; {job.period}</div>
                    </div>
                  </div>
                ))}
              </div>
            </div>
            <Link href="/experience" className="link-arrow text-sm text-accent hover:text-accent-hover transition-colors mt-6">
